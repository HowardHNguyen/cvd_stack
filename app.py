...
stacking_model_url = 'https://raw.githubusercontent.com/HowardHNguyen/cvd/master/stacking_model_calibrated.pkl'

# Local paths for the model files
stacking_model_path = 'stacking_model_calibrated.pkl'
...
if st.sidebar.button('Predict'):
    ...
    try:
        rf_base_model = stacking_model.named_estimators_['rf'].base_estimator
        fig, ax = plt.subplots()
